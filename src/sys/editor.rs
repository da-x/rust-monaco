...
extern "C" {
    ...
    #[wasm_bindgen(js_name = "create", js_namespace = ["monacoPackage", "editor"])]
    pub fn create(
    ...
    #[wasm_bindgen(js_name = "onDidCreateEditor", js_namespace = ["monacoPackage", "editor"])]
    ...
    ///
    /// * `override` - `{ [index: string]: any }`
    #[wasm_bindgen(js_name = "createDiffEditor", js_namespace = ["monacoPackage", "editor"])]
    ...
    #[wasm_bindgen(js_name = "createDiffNavigator", js_namespace = ["monacoPackage", "editor"])]
    ...
    #[wasm_bindgen(js_name = "createModel", js_namespace = ["monacoPackage", "editor"], catch)]
    pub fn create_model(value: &str, language: Option<&str>, uri: Option<&Uri>) -> Result<ITextModel, JsValue>;

    /// Change the language for a model.
    #[wasm_bindgen(js_name = "setModelLanguage", js_namespace = ["monacoPackage", "editor"])]
    ...
    ///
    /// * `markers` - `IMarkerData[]`
    #[wasm_bindgen(js_name = "setModelMarkers", js_namespace = ["monacoPackage", "editor"])]
    ...
    ///
    /// `IMarker[]`
    #[wasm_bindgen(js_name = "getModelMarkers", js_namespace = ["monacoPackage", "editor"])]
    pub fn get_model_markers(filter: &Object) -> Array;

    /// Get the model that has `uri` if it exists.
    #[wasm_bindgen(js_name = "getModel", js_namespace = ["monacoPackage", "editor"])]
    ...
    ///
    /// `ITextModel[]`
    #[wasm_bindgen(js_name = "getModels", js_namespace = ["monacoPackage", "editor"])]
    ...
    #[wasm_bindgen(js_name = "onDidCreateModel", js_namespace = ["monacoPackage", "editor"])]
    ...
    ///
    /// * `listener` - `(model: ITextModel) => void`
    #[wasm_bindgen(js_name = "onWillDisposeModel", js_namespace = ["monacoPackage", "editor"])]
    ...
    ///   string; }) => void`
    #[wasm_bindgen(js_name = "onDidChangeModelLanguage", js_namespace = ["monacoPackage", "editor"])]
    ...
    /// proxied.
    #[wasm_bindgen(js_name = "createWebWorker", js_namespace = ["monacoPackage", "editor"])]
    pub fn create_web_worker(opts: &IWebWorkerOptions) -> MonacoWebWorker;

    /// Colorize the contents of `domNode` using attribute `data-lang`.
    #[wasm_bindgen(js_name = "colorizeElement", js_namespace = ["monacoPackage", "editor"])]
    pub fn colorize_element(dom_node: &HtmlElement, options: &IColorizerElementOptions) -> Promise;

    /// Colorize `text` using language `languageId`.
    #[wasm_bindgen(js_name = "colorize", js_namespace = ["monacoPackage", "editor"])]
    pub fn colorize(text: &str, language_id: &str, options: &IColorizerOptions) -> Promise;

    /// Colorize a line in a model.
    #[wasm_bindgen(js_name = "colorizeModelLine", js_namespace = ["monacoPackage", "editor"])]
    ...
    ///
    /// `Token[][]`
    #[wasm_bindgen(js_name = "tokenize", js_namespace = ["monacoPackage", "editor"])]
    pub fn tokenize(text: &str, language_id: &str) -> Array;

    /// Define a new theme or update an existing theme.
    #[wasm_bindgen(js_name = "defineTheme", js_namespace = ["monacoPackage", "editor"])]
    pub fn define_theme(theme_name: &str, theme_data: &IStandaloneThemeData);

    /// Switches to a theme.
    #[wasm_bindgen(js_name = "setTheme", js_namespace = ["monacoPackage", "editor"])]
    pub fn set_theme(theme_name: &str);

    /// Clears all cached font measurements and triggers re-measurement.
    #[wasm_bindgen(js_name = "remeasureFonts", js_namespace = ["monacoPackage", "editor"])]
    pub fn remeasure_fonts();

    #[derive(Debug)]
    #[wasm_bindgen(js_namespace = ["monacoPackage", "editor"])]
    ...
    #[derive(Debug)]
    #[wasm_bindgen(extends = BareFontInfo, js_namespace = ["monacoPackage", "editor"])]
    pub type FontInfo;
